...
namespace EduSoft.Data.Migrations
{
    ...
    [Migration("20230227100258_Add-some-changes-db-add-ImageIntro-and-SubChapterIntro")]
    partial class AddsomechangesdbaddImageIntroandSubChapterIntro
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduSoft.Entities.Tutorials.IntroImages", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SubChapterIntroId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("SubChapterIntroId");

                    b.ToTable("IntroImages");
                });
            ...
            modelBuilder.Entity("EduSoft.Entities.Tutorials.IntroImages", b =>
                {
                    b.HasOne("EduSoft.Entities.Tutorials.SubChapterIntro", "SubChapterIntro")
                        .WithMany("Images")
                        .HasForeignKey("SubChapterIntroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
